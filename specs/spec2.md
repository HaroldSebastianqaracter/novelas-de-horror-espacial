...
> **Decisión entrevistada, 24 de septiembre de 2026, tras la pasada real de tres capítulos.** El capítulo 2 paró porque la «Fibra dorsal», la línea que lleva calor y señal por toda la estación, aparecía en el anillo habitable con su última ubicación en la sala de antenas. La prosa no la traía al anillo: allí solo se hablaba de ella («Fibra para dos»). La escena la había puesto la escaleta, y el extractor, que sí sitúa un objeto cuando lo ve en un sitio nuevo, no la situó. Tal como está escrita, la comprobación solo salta en ese caso: si el extractor registra el objeto en la escena nueva, ese estado cuenta como traslado. Lo que detecta es que la escaleta y el canon no coinciden, no un error de la prosa. En las dos novelas reales saltó dos veces, y las dos eran falsos positivos. Se descartó distinguir las instalaciones fijas de los objetos portátiles (una marca en el elenco), que modela mejor el dominio pero toca el esquema, el elenco y su skill. **Lo que se pierde:** si la prosa lleva un objeto a otro sitio y el extractor no lo registra, la novela ya no para; queda como aviso en el informe (caso C05 del banco).
