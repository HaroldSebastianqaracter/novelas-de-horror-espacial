...
| --- | --- | --- | --- |
| 10 | Las propiedades valen para 6 capítulos o más, 4 intentos o más, o 4 fallos | TLC explora un modelo finito, y con 5 capítulos y 3 fallos ya son millones de estados | Ninguna acción del modelo depende del número de capítulo más allá de «siguiente» y «desde d». Los fallos que encuentran los modelos de este tipo suelen salir con muy pocos pasos: la traza del hallazgo 1 tiene 11 estados, y la del renombrado, 29 |
