...
| `cambio_toca_otro` | Renombrar: un nombre protegido (de otra entidad, RF3-CAM-11) sale en la prosa o los resúmenes nuevos menos veces que en los aprobados. Se cuenta fuera del nombre viejo entero: al renombrar «Nina Reyes» con «Reyes» protegido, el «Reyes» de «Nina Reyes» no es el otro |
...
| --- | --- | --- |
| Tres intentos sin pasar un capítulo, o el paso final se deshace (puertas 1 y 2, o un error de datos: de la base o un dato del canon que ya no cuadra) | Vuelve a su estado completado por la misma puerta 5, sin versión nueva porque el texto no cambió | `fallido`, con el informe, y el evento `cambio_fallido` |
