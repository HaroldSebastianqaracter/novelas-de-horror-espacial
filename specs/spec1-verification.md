...
Actualizado el 23 de septiembre de 2026. Suite: 204 tests en verde, 1 marcado `modelo` y 1 marcado `agente`; `ruff` limpio y `pyright` estricto en cero sobre `src/backend` sin los tests. Las rutas de evidencia son relativas a `src/backend/`.
