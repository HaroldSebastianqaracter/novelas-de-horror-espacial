...
Actualizado el 23 de septiembre de 2026. Suite: 127 tests en verde y 1 `xfail` estricto, la reproducción de la auditoría que aún no ha cerrado ninguna fase de spec2. Las rutas de evidencia son relativas a `src/backend/`.
