...
Esta lista es la única fuente de verdad sobre lo ocurrido antes: no podés leer los capítulos
anteriores, así que lo que no esté aquí no pasó, y lo que esté aquí sigue siendo cierto aunque la
escena pida lo contrario. Si el objetivo narrativo choca con un hecho, manda el hecho: reescribí la
escena para que ocurra sin contradecirlo.
{{HECHOS}}
