...
La entrada se prepara con `python -m harness ui` (formulario local) o editando `01_concepto/idea.md` y `config/`.
...
- Para leer lo generado: `python -m harness ensamblar --salida <archivo>`, y se le muestra la ruta al usuario.
