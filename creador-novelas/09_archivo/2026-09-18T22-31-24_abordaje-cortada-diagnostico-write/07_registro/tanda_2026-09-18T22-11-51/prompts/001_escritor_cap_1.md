# Capítulo 1: «La puerta que se abrió sola»
...
- Título: La puerta que se abrió sola
- Objetivo narrativo: Presentar a los cinco tripulantes del remolcador en la rutina del arrastre y romperla: la esclusa de carga se abre sin secuencia, algo entra en la nave y mata a Halim Duarte delante de los otros cuatro antes de perderse por los conductos de servicio.
- Personajes en escena: Irene Sacchi, Bruno Oyarce, Mirta Kovačić, Teo Almendra, Halim Duarte, la presencia
- Locación: Vereda Larga - cubierta de carga
- Información nueva que el lector debe obtener aquí: Faltan once días hasta puerto, no hay ayuda posible a esa distancia y la única puerta que se abrió en toda la travesía la abrió lo que subió a bordo; Bruno propone sellar la nave sección por sección y Mirta calcula que el aire y la energía del sellado dan días, no semanas.
...
- [locacion · Vereda Larga - cubierta de carga · cap. 0] La cubierta de carga reúne la esclusa de carga, su terminal interno y el torno del cable de arrastre, y es el único punto de la nave desde el que se trabaja el remolque a mano.
...
### Irene Sacchi
- Estado físico: Sana, con el cansancio acumulado de una travesía larga de arrastre; duerme en turnos cortos.
- Estado psicológico: Manda la Vereda Larga por costumbre más que por galones y le pesa: firme hacia fuera, pendiente por dentro de no equivocarse delante de la tripulación.
...
### Mirta Kovačić
- Estado físico: Sana, con el oído castigado de guardias largas con auriculares en una banda vacía.
- Estado psicológico: Escéptica y exacta; convierte cualquier situación en cifras de aire, energía y tiempo, y confía más en el cálculo que en lo que le dicen.
- Secretos que conoce: ninguno registrado
- Dónde quedó: sin registrar
- Última aparición: todavía no apareció
...
### Halim Duarte
- Estado físico: Sano, al final de una guardia larga en la cubierta de carga.
- Estado psicológico: Rutinario y confiado, trata la guardia de la esclusa como un trámite de once días iguales.
- Secretos que conoce: En su guardia el ciclo de presurización de la esclusa de carga quedó desactivado a mano.
- Dónde quedó: sin registrar
- Última aparición: todavía no apareció

### la presencia
- Estado físico: Grande, capaz de moverse por los conductos de servicio y de dejar arañazos largos en el metal; ninguna medición de a bordo la describe entera.
- Estado psicológico: No responde a frecuencias ni a protocolos de contacto; su conducta se lee como aprendizaje del casco, no como huida.
- Secretos que conoce: ninguno registrado
- Dónde quedó: sin registrar
- Última aparición: todavía no apareció

## Hacia dónde sigue la novela
El capítulo siguiente (2) transcurre en: Vereda Larga - eje central. Dejá esta escena de modo que la acción pueda continuar allí (los personajes que sigan en juego, en camino o ya en esa locación), sin narrar lo que ocurrirá en él ni adelantar su información nueva.
...
2. **Prohibido introducir personajes** que no estén en esta lista: Irene Sacchi, Bruno Oyarce, Mirta Kovačić, Teo Almendra, Halim Duarte, la presencia. Si la escena pide una voz nueva, usá figuras sin nombre y sin peso narrativo (una voz por el intercomunicador, una silueta) que no vuelvan a aparecer. Un personaje nuevo con nombre obliga a regenerar el capítulo.
