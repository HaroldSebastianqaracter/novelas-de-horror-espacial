...
[
  ...
  {
    "sujeto": "sección de máquinas",
    "categoria": "locacion",
    "sujeto_validado": true,
    "hecho": "La sección de máquinas fue sellada desde los pasillos habitables mediante una válvula manual cerrada por Dez Okafor.",
    "cap_origen": 2,
    "superado_por": null
  },
  {
    ...
    "categoria": "personaje",
    "sujeto_validado": true,
    "hecho": "Dez Okafor cerró hace meses un conducto de aire para aliviar presión de un circuito obsoleto, sin registrarlo oficialmente.",
    "cap_origen": 2,
    "superado_por": null
  },
  {
    ...
    "categoria": "mundo",
    "sujeto_validado": true,
    "hecho": "La nave posee conductos de aire no documentados que conectan secciones distantes de formas no reflejadas en los planos oficiales.",
    "cap_origen": 2,
    "superado_por": null
  },
  {
    ...
    "categoria": "mundo",
    "sujeto_validado": true,
    "hecho": "La criatura/amenaza se desplaza entre cubiertas con regularidad, ocupando el ramal doce (dos cubiertas arriba de la sección de máquinas) que teóricamente no existe en los registros.",
    "cap_origen": 2,
    "superado_por": null
  },
  {
    ...
    "categoria": "mundo",
    "sujeto_validado": true,
    "hecho": "La criatura fue expulsada hacia el espacio a través de la esclusa de mantenimiento durante la descompresión.",
    "cap_origen": 3,
    "superado_por": null
  },
  {
    "sujeto": "sección de mantenimiento",
    "categoria": "locacion",
    "sujeto_validado": false,
    "hecho": "Media sección de mantenimiento fue despresurizada y se perdió hacia el espacio.",
    "cap_origen": 3,
    "superado_por": null
  },
  {
    ...
    "categoria": "personaje",
    "sujeto_validado": true,
    "hecho": "Dez resultó herido en la mano durante la maniobra de cierre manual del ramal.",
    "cap_origen": 3,
    "superado_por": null
  },
  {
    ...
    "categoria": "mundo",
    "sujeto_validado": true,
    "hecho": "Quedan once horas de trayecto hasta llegar a puerto.",
    "cap_origen": 3,
    "superado_por": null
  }
]
...
[
  {
    "recurso": "tic lexico 'rejilla' como nombre unico del acceso al conducto",
    "veces": 3,
    "caps": [
      1
    ]
  ...
  {
    "recurso": "caracterizacion por el objeto que el personaje lleva en la mano al entrar en escena",
    "veces": 6,
    "caps": [
      1,
      2
  ...
  {
    "recurso": "estructura paralela de presentacion por rutina repetida y futil",
    "veces": 5,
    "caps": [
      1,
      2
  ...
  {
    "recurso": "vocativo de apertura de dialogo '-Puente -dijo X'",
    "veces": 4,
    "caps": [
      1,
      2
  ...
  {
    "recurso": "afirmacion seguida de negacion breve ('Fue caminando. No corrio.')",
    "veces": 4,
    "caps": [
      1,
      2
  ...
  {
    "recurso": "el compresor como 'temblor domestico' que humaniza la nave",
    "veces": 2,
    "caps": [
      2
    ]
  ...
  {
    "recurso": "la amenaza descrita con vocabulario de turno laboral ('tiene rutina', 'regularidad de un turno de guardia', 'silencio funcional')",
    "veces": 2,
    "caps": [
      2
    ]
  ...
  {
    "recurso": "la nave o el pasillo que dejan de pertenecer a la tripulacion",
    "veces": 2,
    "caps": [
      2
    ]
