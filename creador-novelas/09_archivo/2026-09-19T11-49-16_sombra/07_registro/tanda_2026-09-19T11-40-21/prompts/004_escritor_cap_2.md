# Capítulo 2: «Lo que dejó ordenado»
...
- Título: Lo que dejó ordenado
- Objetivo narrativo: Denny e Iris confirman que los apagones se expanden sector a sector desde el turno en que desapareció Marsh; Tobías halla sus herramientas ordenadas a propósito, y Vela decide que la única salida es bajar a los generadores del nivel inferior.
- Personajes en escena: Vela Ostrowski, Denny Ashworth, Iris Kanoa, Tobías Reyes
- Locación: Sala de Control
- Información nueva que el lector debe obtener aquí: Los cortes de energía avanzan sector a sector empujados desde dentro de los conductos y comenzaron exactamente con la desaparición de Marsh; los generadores de reserva del nivel inferior son la única forma de recuperar la estación.
...
- [mundo · mundo · cap. 0] Los registros de mantenimiento de la estación Perséfone no recogen ningún patrón previo de apagones que avancen sector a sector.
- [mundo · mundo · cap. 0] El soporte vital de la estación depende del reactor central y de generadores de reserva en el nivel inferior que solo se activan de forma manual.
- [mundo · mundo · cap. 0] Los diagnósticos del reactor no han mostrado, hasta ahora, ninguna falla mecánica que explique los apagones anteriores.
- [personaje · Vela Ostrowski · cap. 0] Vela Ostrowski es la ingeniera de turno encargada de revisar los diagnósticos del reactor.
- [personaje · Denny Ashworth · cap. 0] Denny Ashworth es el jefe de cuadrilla y desconfía de los sistemas automáticos; prefiere explicaciones mecánicas para cualquier fallo.
- [personaje · Iris Kanoa · cap. 0] Iris Kanoa es la técnica de soporte vital y lleva meses documentando fallos de la estación que nadie más registra.
- [personaje · Tobías Reyes · cap. 0] Tobías Reyes es minero novato y todavía no conoce bien los tramos más viejos de la estación.
- [personaje · Marsh Okonkwo · cap. 0] Marsh Okonkwo es el operador de comunicaciones que debe relevar a Vela Ostrowski esa noche.
- [personaje · Marsh Okonkwo · cap. 1] Marsh Okonkwo desapareció mientras cruzaba el sector C durante el tercer apagón, dejando solo su radio abierta en el suelo transmitiendo estática.
- [mundo · mundo · cap. 1] Los tres apagones de la semana duraron nueve, veintiséis y ciento cuatro segundos, cada uno más largo que el anterior.
- [personaje · Iris Kanoa · cap. 1] Iris Kanoa anota en un cuaderno propio la duración exacta de cada apagón y otros fallos que los sistemas no registran.

## Dónde quedó la escena (resumen rodante de los últimos capítulos)
## Capítulo 1

Vela no encuentra nada anómalo en los diagnósticos del reactor mientras Denny insiste en un fallo mecánico e Iris muestra que los apagones se alargan.
Marsh avisa por radio que cruza el sector C hacia el relevo y las luces caen a mitad de frase: ciento cuatro segundos de oscuridad.
Al volver la luz encuentran su radio abierta en el suelo y una marca húmeda que se pierde en el conducto de mantenimiento, con la rejilla retirada.
Los cuatro suben hacia la Sala de Control.
...
### Vela Ostrowski
- Estado físico: Sana, al final de su turno, sin relevo.
- Estado psicológico: Alarmada y decidida; ya no cree que los apagones sean casualidad.
- Secretos que conoce: ninguno registrado
- Dónde quedó: sin registrar
- Última aparición: cap. 1

### Denny Ashworth
- Estado físico: Sano; con restos del residuo húmedo en el pulgar.
- Estado psicológico: Sostiene la hipótesis mecánica, pero desconcertado tras tocar la marca.
- Secretos que conoce: ninguno registrado
- Dónde quedó: sin registrar
- Última aparición: cap. 1

### Iris Kanoa
- Estado físico: Cansada; con su cuaderno de fallos en la mano.
- Estado psicológico: Concentrada en la duración creciente de los cortes; teme tener razón.
- Secretos que conoce: ninguno registrado
- Dónde quedó: sin registrar
- Última aparición: cap. 1
...
### Tobías Reyes
- Estado físico: Sano.
- Estado psicológico: Asustado; fue quien vio primero la marca húmeda.
- Secretos que conoce: ninguno registrado
- Dónde quedó: sin registrar
- Última aparición: cap. 1

### Marsh Okonkwo
- Estado físico: Desaparecido durante el apagón; paradero desconocido.
- Estado psicológico: Desconocido; su última transmisión era rutinaria y tranquila.
- Secretos que conoce: ninguno registrado
- Dónde quedó: sin registrar
- Última aparición: cap. 1

## Hacia dónde sigue la novela
El capítulo siguiente (3) transcurre en: Nivel Inferior. Dejá esta escena de modo que la acción pueda continuar allí (los personajes que sigan en juego, en camino o ya en esa locación), sin narrar lo que ocurrirá en él ni adelantar su información nueva.
...
- Denny desestima los diagnósticos automáticos con una réplica seca · 2 veces · cap. 1
- el cuaderno de fallos de Iris como archivo de lo que los sistemas no ven · 2 veces · cap. 1
- la duración en segundos del apagón como medida creciente de la amenaza · 2 veces · cap. 1
- la radio abierta transmitiendo estática en ausencia de su dueño · 1 vez · cap. 1
- objeto dejado con cuidado y orden por la criatura (rejilla apoyada) · 1 vez · cap. 1

## Reglas de producción
1. Longitud objetivo: **400 palabras**, tolerancia ±20 % (entre 320 y 480). Contá antes de entregar.
2. **Prohibido introducir personajes** que no estén en esta lista: Vela Ostrowski, Denny Ashworth, Iris Kanoa, Tobías Reyes, Marsh Okonkwo. Si la escena pide una voz nueva, usá figuras sin nombre y sin peso narrativo (una voz por el intercomunicador, una silueta) que no vuelvan a aparecer. Un personaje nuevo con nombre obliga a regenerar el capítulo.
...
Registro de sujetos, usá estos nombres exactos. Personajes: Vela Ostrowski,Denny Ashworth,Iris Kanoa,Tobías Reyes,Marsh Okonkwo. Locaciones: Sector C,Sala de Control,Nivel Inferior. Y `mundo` para lo general.
