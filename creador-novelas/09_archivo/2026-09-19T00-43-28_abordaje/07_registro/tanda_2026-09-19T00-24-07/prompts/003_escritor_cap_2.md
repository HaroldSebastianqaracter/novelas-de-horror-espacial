# Capítulo 2: «Cada mamparo que bajamos»
...
- Título: Cada mamparo que bajamos
- Objetivo narrativo: Aplicar la doctrina de sellado y verla fallar: los golpes llegan desde secciones ya cerradas, el consumo de aire es el de cinco cuerpos y el registro de la esclusa revela que el código de servicio se introdujo desde dentro, con la clave de Bakó.
- Personajes en escena: Vinter, Sadhu, Kerr, Ilesanmi, la presencia
- Locación: Cubierta de máquinas del Amanecer Tardío
- Información nueva que el lector debe obtener aquí: A la presencia la dejaron entrar desde dentro; no ha vuelto a matar pese a tener ocasión y ocupa exactamente el volumen que le ceden, siempre en dirección al puente: no la acorralan, los conduce.
...
- [locacion · Cubierta de máquinas del Amanecer Tardío · cap. 0] Desde la consola de la cubierta de máquinas se gobiernan los mamparos, la presión de cada sección y el reparto de energía de la nave.
...
### Vinter
- Estado físico: Ileso.
- Estado psicológico: Autoridad perdida ante lo imposible. Vio a Bakó atacado sin aviso y supo que no había nada que ordenar. Reactiva la autoridad dando instrucciones.
- Secretos que conoce: Existe una amenaza desconocida en la esclusa de carga que los sensores no registran.
- Dónde quedó: sin registrar
- Última aparición: cap. 1

### Sadhu
- Estado físico: Ileso.
- Estado psicológico: Controlado, protector. Retiene a Kerr del impulso de avanzar.
- Secretos que conoce: El consumo de aire a bordo no ha variado, lo que descarta un escape; la amenaza entró desde fuera.
- Dónde quedó: sin registrar
- Última aparición: cap. 1
...
### Ilesanmi
- Estado físico: Ileso.
- Estado psicológico: Alertado por anomalía, intentó comunicación por radio sin respuesta. El silencio de una radio calibrada le confirma la gravedad.
- Secretos que conoce: Alguien abrió la esclusa de carga 11 minutos antes del turno sin registro de autorización. Las bandas de emergencia de radio están silenciosas (no hay interferencia, hay ausencia completa).
- Dónde quedó: sin registrar
- Última aparición: cap. 1

### la presencia
- Estado físico: Entidad de volumen grande. No emite calor registrable. Color indeterminado para los sensores humanos.
...
El capítulo siguiente (3) transcurre en: Puente del Amanecer Tardío. Dejá esta escena de modo que la acción pueda continuar allí (los personajes que sigan en juego, en camino o ya en esa locación), sin narrar lo que ocurrirá en él ni adelantar su información nueva.
