# Capítulo 3: «Once días hasta puerto»
...
- Objetivo narrativo: Invertir la lógica del sellado despresurizando las cubiertas intermedias, perder a Sadhu abajo y descubrir en el puente que la presencia devuelve el código de la esclusa por la banda de emergencia; Vinter decide abrir y devolverla al vacío.
- Personajes en escena: Vinter, Sadhu, Kerr, Ilesanmi, la presencia
- Locación: Puente del Amanecer Tardío
- Información nueva que el lector debe obtener aquí: El silencio era elección: la presencia repite el código de servicio en la misma frecuencia porque pide salir como pidió entrar; la orden partió de un terminal que Bakó no estaba usando, y la nave atraca al undécimo día con tres supervivientes.
...
- [locacion · Puente del Amanecer Tardío · cap. 0] El puente reúne el mando y el puesto de comunicaciones, se cierra con compuerta estanca y es el compartimento que la tripulación no puede permitirse perder.
- [personaje · Bakó · cap. 1] Bakó fue atacado por la presencia en el pasillo de carga y golpeado contra el mamparo, quedando incapacitado.
- [personaje · la presencia · cap. 1] La presencia se retiró del pasillo de carga hacia los conductos de servicio con economía de movimiento no asociable a un animal.
- [mundo · mundo · cap. 1] La esclusa de carga del Amanecer Tardío fue abierta sin autorización 11 minutos antes del turno de Vinter, según los registros.
- [personaje · Bakó · cap. 2] Bakó abrió la compuerta desde la consola de carga usando su clave, antes de que sonara la alarma.
- [personaje · la presencia · cap. 2] La presencia consume aire en la misma cantidad que un cuerpo humano completo.
- [mundo · mundo · cap. 2] Cada mamparo que la tripulación sella cede territorio a la presencia en lugar de contenerla.
- [personaje · la presencia · cap. 2] La presencia se acomoda en los conductos del compartimento de bombas, avanzando desde popa hacia proa.

## Dónde quedó la escena (resumen rodante de los últimos capítulos)
## Capítulo 1

Cuarto día de travesía rutinaria. Ilesanmi descubre un ciclo de presión anómalo en la esclusa de carga sin autorización.
Los cuatro descienden a investigar y encuentran una entidad desconocida ocupando el pasillo, tan ajena que los sensores no la registran.
Bakó es atacado sin aviso y golpeado contra el mamparo. La presencia se retira hacia los conductos de servicio.
Vinter ordena el abandono del pasillo y el descenso a máquinas.

## Capítulo 2

En la Cubierta de máquinas, el equipo ejecuta un plan de aislamiento progresivo sellando mamparos de popa a proa.
Descubren que Bakó abrió la compuerta desde la consola de carga antes de la alarma, y que la presencia consume aire como un cuerpo entero.
Vinter comprende que cada mamparo que sella cede territorio a la presencia. Ordena subir al puente para cambiar de táctica.
...
### Vinter
- Estado físico: Apoyado en el armazón de la consola
- Estado psicológico: Ha descubierto que su estrategia de contención es contraproducente; toma una decisión crítica de cambiar de eje
- Secretos que conoce: Existe una amenaza desconocida en la esclusa de carga que los sensores no registran.; Sabe que Bakó abrió la compuerta desde la consola de carga; Sabe que la presencia consume aire como un cuerpo entero; Sabe que cada mamparo que sella cede territorio a la presencia
- Dónde quedó: sin registrar
- Última aparición: cap. 2

### Sadhu
- Estado físico: Apartó la mano de la consola
- Estado psicológico: Lee los datos de consumo como una avería crítica; creciente preocupación
- Secretos que conoce: El consumo de aire a bordo no ha variado, lo que descarta un escape; la amenaza entró desde fuera.; Sabe que el consumo de aire equivale al de cinco cuerpos
- Dónde quedó: sin registrar
- Última aparición: cap. 2

### Kerr
- Estado físico: Ileso, retenido.
- Estado psicológico: Reflejo de avance atajado. Conocimiento específico de los conductos.
- Secretos que conoce: Los conductos de servicio van de la bodega al puente y comunican todas las cubiertas.
- Dónde quedó: sin registrar
- Última aparición: cap. 1

### Ilesanmi
- Estado físico: En cuclillas junto al terminal
- Estado psicológico: Ha hecho un descubrimiento perturbador sobre Bakó
- Secretos que conoce: Alguien abrió la esclusa de carga 11 minutos antes del turno sin registro de autorización. Las bandas de emergencia de radio están silenciosas (no hay interferencia, hay ausencia completa).; Sabe que el registro del ciclo de presión lleva la clave de Bakó; Sabe que se tecleó desde la consola de carga, no desde la compuerta exterior
- Dónde quedó: sin registrar
- Última aparición: cap. 2

### la presencia
- Estado físico: Acomodada en un conducto
- Estado psicológico: Sin atribuciones psicológicas humanas; continúa ocupando territorio de forma metódica
- Secretos que conoce: ninguno registrado
- Dónde quedó: sin registrar
- Última aparición: cap. 2

### Bakó
- Estado físico: Golpeado contra el mamparo, incapacitado. El ataque duró menos de lo que tarda un pulmón en vaciarse.
- Estado psicológico: Sin datos.
- Secretos que conoce: ninguno registrado
- Dónde quedó: sin registrar
- Última aparición: cap. 1
...
- El plano trazado y revisado como herramienta de pensamiento táctico · 3 veces · cap. 2
- Secciones y rectángulos como lenguaje geométrico de control territorial · 2 veces · cap. 2
- sensores incapaces de registrar la amenaza (sin calor, sin color identificable) · 2 veces · cap. 1
- Confirmación de cierres en líneas verdes en la consola · 1 vez · cap. 2
- La presencia acomodándose en conductos, ocupación silenciosa y metódica · 1 vez · cap. 2
- Lectura de datos técnicos como quien lee una avería · 1 vez · cap. 2
- Orden breve e imperativa para cambiar de eje táctico · 1 vez · cap. 2
- economía de movimiento de lo desconocido como evidencia de no-naturalidad · 1 vez · cap. 1
- pérdida de agencia de Vinter ante lo innombrable (nada que ordenar) · 1 vez · cap. 1
- silencio de una radio bien calibrada como peso existencial mayor que el ruido · 1 vez · cap. 1
- zumbido del soporte vital como marca de normalidad perdida · 1 vez · cap. 1

## Reglas de producción
1. Longitud objetivo: **400 palabras**, tolerancia ±20 % (entre 320 y 480). Contá antes de entregar.
2. **Prohibido introducir personajes** que no estén en esta lista: Vinter, Sadhu, Kerr, Ilesanmi, la presencia, Bakó. Si la escena pide una voz nueva, usá figuras sin nombre y sin peso narrativo (una voz por el intercomunicador, una silueta) que no vuelvan a aparecer. Un personaje nuevo con nombre obliga a regenerar el capítulo.
