# Extracción de estado del capítulo 2
...
Leé con la herramienta Read el archivo **C:/Users/harold.rodriguez/Desktop/Nueva carpeta/velocidad/creador-novelas/05_manuscrito/cap_2.md** y nada más del manuscrito. Cualquier otra ruta de `05_manuscrito/` está bloqueada y no la necesitás.

## Registro de sujetos (vocabulario canónico, no memoria)
- Personajes: Irene Calvo, Tomás Bregan, Nadia Sorel, Emilio Vart, Cabo Illán, la presencia
- Locaciones: Cubierta de carga del Cinturón de Hierro, Conductos de servicio del Cinturón de Hierro, Puente de mando del Cinturón de Hierro
...
## Qué escribir
Un único objeto JSON con este esquema, escrito con Write en **C:/Users/harold.rodriguez/Desktop/Nueva carpeta/velocidad/creador-novelas/04_estado/deltas/delta_cap_2.json** (esa ruta exacta y ninguna otra), sin texto antes ni después, sin bloque de código:
...
`.venv/Scripts/python.exe -m app validar-delta 2`
...
`delta_cap_2.json · <hechos> hechos · <personajes> personajes · validado`

Si tras tres intentos el validador sigue fallando (EX-10), terminá en cambio con: `delta_cap_2.json · NO VALIDADO · <último error textual del validador>`.
