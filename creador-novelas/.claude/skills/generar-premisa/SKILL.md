...
Condición de entrada: `01_concepto/idea.md` existe y no está vacío. Si falta, pedile la idea al usuario (o que la escriba con `python -m app ui`) y detenete.
...
2. Guardá el borrador con Write en `.tanda/borradores/premisa.md` y persistilo con
   `.venv/Scripts/python.exe -m app guardar premisa --desde .tanda/borradores/premisa.md`
