...
context: fork
allowed-tools: Read, Glob, Write, Bash(.venv/Scripts/python.exe -m app:*)
...
4. Escribí el borrador con Write en `.tanda/borradores/style_guide.md` y persistilo con:
   `.venv/Scripts/python.exe -m app guardar style_guide --desde .tanda/borradores/style_guide.md`
