# Capítulo 4: «Un tercio de potencia»
...
- Título: Un tercio de potencia
- Objetivo narrativo: Pedro intenta subir el rendimiento del reactor secundario siguiendo el manual paso a paso; consigue una mejora mínima a cambio de perder la calefacción de la cubierta inferior.
- Personajes en escena: Pedro Sánchez, Mesa
- Locación: Sala del reactor
- Información nueva que el lector debe obtener aquí: Cada reparación cobra un precio: la cubierta inferior queda a temperatura de almacén; Mesa registra una masa en los conductos que Pedro atribuye a un sensor sucio.
...
- [locacion · Sala del reactor · cap. 0] La sala del reactor es el único compartimento del Falcon donde no hace frío; alberga el arco de soldadura.
...
- [locacion · Sala del reactor · cap. 3] El reactor principal está cortado desde las 23:06 y su bus de control es inaccesible tras un pasillo sellado por Mesa.
...
## Qué hacer
1. Escribí el capítulo completo con la herramienta Write en **C:/Users/harold.rodriguez/Desktop/Nueva carpeta/novelas-de-horror-espacial/creador-novelas/05_manuscrito/cap_4.md** (esa ruta exacta y ninguna otra).
2. Validalo (RF-08.4): ejecutá con Bash **exactamente** este comando, sin agregar ni cambiar nada:
   `.venv/Scripts/python.exe -m app validar-capitulo 4`
...
`cap_4.md · <número de palabras> palabras · personajes: <nombres separados por coma> · validado`

Si tras tres intentos el validador sigue fallando (EX-10), terminá en cambio con: `cap_4.md · NO VALIDADO · <último error textual del validador>`.
