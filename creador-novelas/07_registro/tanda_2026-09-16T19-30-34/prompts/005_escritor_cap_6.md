...
- Título: Sin manifiesto
- Objetivo narrativo: Con luz de día artificial, Pedro revisa los registros de la última carga recogida en Vellón y encuentra el contenedor sellado sin manifiesto, ahora vacío y cubierto de escarcha orgánica.
- Personajes en escena: Pedro Sánchez, Mesa
- Locación: Bodega de carga
- Información nueva que el lector debe obtener aquí: El contenedor sin manifiesto subió en la estación de tránsito Vellón; su interior tiene la misma escarcha ramificada que las quemaduras de Irene.
...
- [personaje · Mesa · cap. 0] Mesa, el sistema de a bordo, habla con voz sintética neutra por los altavoces de cada compartimento y ejecuta cierres que nadie ha ordenado.
...
- [personaje · Pedro Sánchez · cap. 5] Pedro Sánchez se hirió el antebrazo derecho cuando la escotilla de la bodega de carga lo atrapó durante su cierre.
- [locacion · Bodega de carga · cap. 5] El contenedor sin manifiesto en la bodega de carga contiene una capa blanca y ramificada de material fúngico que crece desde las esquinas en líneas que se dividen.
- [locacion · Bodega de carga · cap. 5] La escotilla de acceso a la bodega de carga quedó sellada y estanca sin órdenes registradas en el sistema.
...
- el impulsor de aire arrancando rítmicamente y callándose, llenando silencios huecos · 4 veces · cap. 5
- voces que rebotan desde los conductos y desde el interior de contenedores, deformadas por el espacio · 4 veces · cap. 5
...
- Pedro hablando solo en voz alta para llenar el silencio y oírse a sí mismo · 3 veces · cap. 5
...
- el frío mordiente de la mano en los conductos como contraste con el interior templado · 2 veces · cap. 5
- la escotilla cerrándose lentamente con gemido de servo, como orden deliberada · 2 veces · cap. 5
- material blanco ramificado, fino como musgo de sombra, naciendo de esquinas · 2 veces · cap. 5
...
## Qué hacer
1. Escribí el capítulo completo con la herramienta Write en **C:/Users/harold.rodriguez/Desktop/Nueva carpeta/novelas-de-horror-espacial/creador-novelas/05_manuscrito/cap_6.md** (esa ruta exacta y ninguna otra).
2. Validalo (RF-08.4): ejecutá con Bash **exactamente** este comando, sin agregar ni cambiar nada:
   `.venv/Scripts/python.exe -m app validar-capitulo 6`
...
`cap_6.md · <número de palabras> palabras · personajes: <nombres separados por coma> · validado`

Si tras tres intentos el validador sigue fallando (EX-10), terminá en cambio con: `cap_6.md · NO VALIDADO · <último error textual del validador>`.
