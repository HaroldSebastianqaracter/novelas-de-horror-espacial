# Extracción de estado del capítulo 4
...
Leé con la herramienta Read el archivo **C:/Users/harold.rodriguez/Desktop/Nueva carpeta/novelas-de-horror-espacial/creador-novelas/05_manuscrito/cap_4.md** y nada más del manuscrito. Cualquier otra ruta de `05_manuscrito/` está bloqueada y no la necesitás.
...
## Qué escribir
Un único objeto JSON con este esquema, escrito con Write en **C:/Users/harold.rodriguez/Desktop/Nueva carpeta/novelas-de-horror-espacial/creador-novelas/04_estado/deltas/delta_cap_4.json** (esa ruta exacta y ninguna otra), sin texto antes ni después, sin bloque de código:
...
`.venv/Scripts/python.exe -m app validar-delta 4`
...
`delta_cap_4.json · <hechos> hechos · <personajes> personajes · validado`

Si tras tres intentos el validador sigue fallando (EX-10), terminá en cambio con: `delta_cap_4.json · NO VALIDADO · <último error textual del validador>`.
