...
- **El nombre viejo llamado solo por una palabra que es de otra entidad** («Reyes» para referirse a «Nina Reyes» cuando existe otro «Reyes») es ambiguo y se deja como está: ni se sustituye ni cuenta como nombre viejo. Se prefirió dejar una mención vieja ambigua a reescribir a la otra entidad, que es un fallo de canon seguro. `cambio_toca_otro` sostiene lo segundo aunque el revisor se equivoque (validador de 58e70f0).
