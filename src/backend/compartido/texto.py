...
ETIQUETA_SIN_NOMBRE = re.compile(
    ...
    r"|(?:NOMBRE|APELLIDO|TEL[EÉ]FONO|CORREO|EMAIL|DNI|NIE|PASAPORTE|DOCUMENTO|DIRECCI[OÓ]N"
    r"|EMPRESA|PERSONA|CLIENTE)(?:E?S)?_(?:OCULT|ELIMINAD|REDACTAD|BORRAD|CENSURAD|OMITID)[OA]S?"
    r")\]",
    re.IGNORECASE,
)
