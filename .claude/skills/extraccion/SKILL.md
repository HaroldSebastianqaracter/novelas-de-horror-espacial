...
Un uso es actuar sobre el dato **tal como consta**. Si el personaje llega por su cuenta a una conclusión o a una cifra (calcula, estima, supone), eso no es un uso del hecho del canon que se le parezca, aunque comparta una palabra o un número: es un hecho nuevo, del personaje o de lo que calcula. Si su cálculo da exactamente el dato registrado, es conocimiento por la vía `dedujo`, no un uso. Antes de registrar un uso, comprueba que la escena muestra al personaje actuando sobre ese valor y no sobre otro parecido: «cuarenta horas para diez personas son veintiséis de planta», dicho por quien hace la cuenta, no usa el dato «déficit a las veintiséis horas con once personas».
